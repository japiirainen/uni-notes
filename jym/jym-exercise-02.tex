...
\begin{enumerate}[label=\alph*), nosep]
  ...
  \item jokaista nollasta poikkeavaa kokonaislukua \(x\) kohti on olemassa
    sellainen luku reaaliluku \(y\), että \(xy = 2\),
...
\begin{exercise}
Olkoon \(A\) ja \(B\) joukkoja. Todista \emph{absorpiolait}
\begin{enumerate}[label=\alph*), nosep]
...
\end{scope}
\end{tikzpicture}
\captionof{figure}{Absorpiolakien visualisoinnit Vennin
diagrammmeina. Molemmissa
