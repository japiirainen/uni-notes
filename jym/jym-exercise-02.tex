...
\exerciseheading{Johdatus yliopistomatematiikkaan}{Harjoituksen 2 ratkaisut}
...
\begin{enumerate}[label=\alph*), nosep]
  ...
  \item jokaista nollasta poikkeavaa kokonaislukua \(x\) kohti on olemassa
    sellainen reaaliluku \(y\), että \(xy = 2\),
...
\begin{exercise}
Olkoot \(X = \set{a, b, c, d, e}\) perusjoukko sekä
...
\begin{exercise}
Olkoot \(A\) ja \(B\) joukkoja. Todista \emph{absorptiolait}
\begin{enumerate}[label=\alph*), nosep]
\item \(A \cup (A \cap B) = A\),
\item \(A \cap (A \cup B) = A\).
\end{enumerate}
Havainnollista tuloksia Vennin diagrammeilla.
\end{exercise}
...
Ensimmäisessä tapauksessa \(x \in A\), ja toisessa tapauksessa
...
\end{scope}
\end{tikzpicture}
\captionof{figure}{Absorptiolakien visualisoinnit Vennin
diagrammeina. Molemmissa
...
\begin{exercise}
Olkoot \(A_k = \left]0, \frac{1}{k}\right[, k \in \NN \setminus \set{0}\).
Määritä joukot
\begin{tasks}(4)
...
\leavevmode\par
\begin{enumerate}[label=\alph*), nosep]
\item Olkoon \(n \in \NN \setminus{\set{0}}\). Kun \(1 \leq a < b \leq n\),
...
\item Olkoon \(n \in \NN \setminus{\set{0}}\). Jälleen, kun \(1 \leq
a < b \leq n\),
niin \(\frac{1}{b} < \frac{1}{a}\), joten \(A_b \subset A_a\). Siis
\[
A_n \subset A_{n - 1} \subset \cdots \subset A_2 \subset A_1.
...
\item Jos \(x \leq 0\), niin \(x \notin A_1\). Jos \(x > 0\),
valitaan \(n_0 \in \NN\) niin, että
\(n_0 > \frac{1}{x}\). Tällöin \(\frac{1}{n_0} < x\). Tällöin
\(x \notin\left]0, \frac{1}{n_0}\right[ = A_{n_0}\).
Siis mikään \(x \in \RR\) ei kuulu jokaiseen joukkoon \(A_k\), joten
\[
...
\begin{solution}
Olkoon \(X\) perusjoukko, jolla \(A, B, C \subseteq X\).
Inkluusion määritelmän mukaan väite on kaikilla \(x \in X\) pätevä implikaatio
\[
\begin{aligned}
\forall x \in X \colon \bigl(x \in A \cup (B \cap C)
&\implies x \in (A \cup B) \cap (A \cup C)\bigr).
\end{aligned}
\]
...
\[
\begin{aligned}
&\forall x \in X \colon \bigl(x \in A \lor (x \in B \land x \in C) \\
&\qquad\implies
\left((x \in A \lor x \in B) \land (x \in A \lor x \in C)\right)\bigr).
\end{aligned}
\]
...
\begin{exercise}
Olkoot \(A\), \(B\) ja \(C\) joukkoja. Todista karteesisen tulon osittelulaki
leikkauksen suhteen:
\[
...
\begin{aligned}
D &= (A \cap B) \times C \\
&= \set{(x, y) \colon x \in A \cap B \land y \in C}, \\
E &= (A \times C) \cap (B \times C) \\
&= \set{(x, y) \colon x \in A \land y \in C} \cap \set{(x, y) \colon x \in
B \land y \in C}.
\end{aligned}
\]
...
&\implies (x \in A \land y \in C) \land (x \in B \land y \in C) \\
&\implies (x \in A \land x \in B) \land y \in C \\
...
&= \set{(1,1),(1,2),(2,1),(2,2),(3,1),(3,2)} \\ &\cap \set{(2, 1), (2,
2), (3, 1), (3, 2), (4, 1), (4, 2)} \\
&= \set{(2,1),(2,2),(3,1),(3,2)}.
\end{aligned}
\]
