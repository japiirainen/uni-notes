...
\title{Johdatus yliopistomatematiikkaan\\Harjoituksen 1 ratkaisut}
\date{}
\author{}

\begin{document}

\exerciseheading{Johdatus yliopistomatematiikkaan}{Harjoituksen 1 ratkaisut}
...
\begin{solution}
  ...
  jaollisuuden määritelmän mukaan \(6 \mid 0\).

  Olkoon \(n \in \NN, n \geq 0\) mielivaltainen ja oletetaan, että
  \(6 \mid (n^3 - n)\).
  Osoitetaan
  \[
  ...
  määritelmän mukaan on siis olemassa
  ...
  \]
  joten jaollisuuden määritelmän mukaan
  \begin{align}
    6 & \mid n^3 - n + 3n(n + 1) \\
    \implies
    6 & \mid \left((n + 1)^3 - (n + 1)\right).
...
\begin{exercise}
  ...
  \begin{enumerate}[label=(\arabic*), nosep]
    ...
    \item Jos \(n\) on jaollinen neljällä, niin \(n\) on jaollinen kahdella.
  ...
  \begin{enumerate}[label=(\arabic*), nosep]
    ...
    \begin{enumerate}[label=\alph*), nosep]
      ...
      \item \textbf{Vastaesimerkki:} Olkoon \(n = 2\). Koska \(2 = 1\cdot 2\) ja
        \(1 \in \ZZ\), jaollisuuden määritelmän mukaan
        \(2 \mid 2\). Jos \(4 \mid 2\), olisi olemassa
