...
\begin{solution}
Merkitään \(B = p_1 \leftrightarrow (p_0 \rightarrow \neg p_2)\) ja
\(C = p_0 \lor (\neg p_2 \land \neg p_1)\). Alkuperäisen lauseen
\(B \land C\) totuustaulu on
\[
\begin{array}{ccc|cc|c}
p_0 & p_1 & p_2 & B & C & B \land C \\
\hline
0 & 0 & 0 & 0 & 1 & \mathbf{0} \\
0 & 0 & 1 & 0 & 0 & \mathbf{0} \\
0 & 1 & 0 & 1 & 0 & \mathbf{0} \\
...
\end{array}
\]
Soveltamalla DNF-konstruktiota totuustaulun 1-riveihin saadaan seuraava
...
\begin{solution}
Merkitään \(B = p_1 \land (p_0 \rightarrow p_2)\) ja
\(C = p_2 \rightarrow (p_1 \rightarrow p_2)\). Alkuperäisen lauseen
\(B \leftrightarrow C\) totuustaulu on
\[
\begin{array}{ccc|cc|c}
p_0 & p_1 & p_2 & B & C & B \leftrightarrow C \\
\hline
0 & 0 & 0 & 0 & 1 & \mathbf{0} \\
0 & 0 & 1 & 0 & 1 & \mathbf{0} \\
0 & 1 & 0 & 1 & 1 & \mathbf{1} \\
...
Lauseen \(A\) totuustaulu on
\[
\begin{array}{ccc|cc|c}
p_0 & p_1 & p_2 & \neg(p_0 \leftrightarrow p_1)
& p_2 \land \neg p_1 & A \\
\hline
0 & 0 & 0 & 0 & 0 & \mathbf{1} \\
0 & 0 & 1 & 0 & 1 & \mathbf{1} \\
...
\end{array}
\]
Soveltamalla DNF-konstruktiota
...
\]
Ekvivalenssi \(\neg B^{'} \iff B^{'} \downarrow B^{'}\) voidaan
varmistaa totuustaulusta:
\[
\begin{array}{c|cc}
B^{'} & \neg B^{'} & B^{'} \downarrow B^{'} \\
\hline
...
\end{aligned}
\]
Ekvivalenssi \(B^{'} \land C^{'} \iff
(B^{'} \downarrow B^{'}) \downarrow (C^{'} \downarrow C^{'})\)
voidaan varmistaa totuustaulusta:
\[
\begin{array}{cc|cc|cc}
B^{'} & C^{'} & B^{'} \downarrow B^{'} & C^{'} \downarrow C^{'}
& B^{'} \land C^{'}
& (B^{'} \downarrow B^{'}) \downarrow (C^{'} \downarrow C^{'}) \\
\hline
0 & 0 & 1 & 1 & \mathbf{0} & \mathbf{0} \\
0 & 1 & 1 & 0 & \mathbf{0} & \mathbf{0} \\
1 & 0 & 0 & 1 & \mathbf{0} & \mathbf{0} \\
1 & 1 & 0 & 0 & \mathbf{1} & \mathbf{1}
\end{array}
\]
Totuustaulujen kaksi viimeistä saraketta ovat samat, joten ekvivalenssit
pätevät kaikilla totuusjakaumilla.
